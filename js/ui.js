...
export function renderStatusTab() {
  ...
  if (achList) {
    ...
    const ACH_PROGRESS = {
      ...
      photo_aurora: [state.gotAuroraPhoto ? 1 : 0, 1],
      photo_rain: [state.gotRainPhoto ? 1 : 0, 1],
...
const LOADING_TIPS = [
  ...
  '体力が満ちた状態で焚き火に休むと、夜明けや日暮れまで時間を進められる。',
  '戦闘中の「集中」(6キー)はスタミナとエーテルを取り戻し、次の攻撃の威力を40%上げる。',
  '夜になると出現する野生生物や現象もある。',
  '雪原バイオームで夜を迎えると、空にオーロラが現れる。',
  '撮影テーマ（明け方・夕暮れ／オーロラ／雨天）を満たした写真は欠片がもらえる。',
