...
export const ITEMS = {
  ...
  accessory_hunter:    { id:'accessory_hunter', slot:'accessory', name:'野伏の首飾り', atk:5, crit:5, desc:'幾度も結晶獣を狩った者だけが手にする首飾り。獣の気配を鋭く捉える。' },
...
export const SKILLS = [
  ...
  { id:'desperation', name:'背水の残光',   cost:55, desc:'HPが30%以下のとき、与ダメージが+35%される。', effect:{ lowHpAtkPct:0.35 } },
...
export const ACHIEVEMENTS = [
  ...
  { id:'dodge_master', name:'紙一重の舞', desc:'攻撃を累計50回、華麗に回避する。', reward:40 },
  ...
  { id:'aurora_witness', name:'極夜の輝き', desc:'雪原の夜に現れるオーロラを目にする。', reward:45 },
